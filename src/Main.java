public class Main {
    ...
    public static int[] combine(int[] array1, int[] array2) {
        int[] rA = new int[array1.length + array2.length];
    ...
    public static int[] zip(int[] array1, int[] array2) {
        int[] rA = new int[array1.length + array2.length];
        for (int i = 0; i < array1.length + array2.length; i++) rA[i] = i%2==0?array1[i/2]:array2[(i-1)/2];
        return rA;
    }
    ...
    public static int[] product(int[] array1, int[] array2) {
        int[] rA = new int[array1.length];
        for (int i = 0; i < array1.length; i++) rA[i] = array1[i] * array2[i];
        return rA;
    }
    ...
    public static int[] capitalCount(String[] words) {
        int[] rA = new int[words.length];
        for (int i = 0; i < words.length; i++) rA[i] = countCapitalLetters(words[i]);
        return rA;
    }

    public static int countCapitalLetters(String word) {
        int count = 0;
        for (int i = 0; i < word.length(); i++) if ((int)word.charAt(i) >= 65 && (int)word.charAt(i) <= 90) count++;
        return count;
